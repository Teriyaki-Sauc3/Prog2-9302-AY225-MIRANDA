/**
 * =====================================================
 * Student Name    : Miranda, John Paul Benedict G.
 ...
 *   to Miranda, John Paul Benedict G. for Math 101. The solution is computed using cofactor
...
public class DeterminantSolver {
    ...
    static int[][] matrix = {
        { 4, 3, 6 },   // Row 1 of assigned matrix
        { 2, 5, 1 },   // Row 2 of assigned matrix
    ...
    static void solveDeterminant(int[][] m) {
        ...
        System.out.println("  Student: Miranda, John Paul Benedict G.");
        ...
        System.out.printf("  Determinant = %d + (%d) + %d = %d%n", c11, c12, c13, determinant);
        System.out.println("=".repeat(52));
    }

    // ── SECTION 5: Main Method ────────────────────────────────────────
    // The entry point of the program. It calls the main solver method.
